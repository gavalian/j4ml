 ...
 * @author gavalian
 */
public class RegressionExample2 {
    ...
    public static MultiLayerNetwork createNetwork(){
        ...
        listBuilder.layer(0, new DenseLayer.Builder().nIn(4).nOut(4)
                .weightInit(WeightInit.XAVIER)
                .build());
        listBuilder.layer(1, new DenseLayer.Builder().nIn(4).nOut(2)
                .weightInit(WeightInit.XAVIER)
                .build());
         listBuilder.layer(2, new DenseLayer.Builder().nIn(2).nOut(4)
                .weightInit(WeightInit.XAVIER)
                .build());
        listBuilder.layer(3, new OutputLayer.Builder().nIn(4).nOut(4)
    ...
    public static void main(String[] args){
        ...
        DataSet dstrain = RegressionExample2.createDataSet(80000);
        DataSet dstest  = RegressionExample2.createDataSet(200);
        
        
        System.out.println(dstrain);
        MultiLayerNetwork network = RegressionExample2.createNetwork();
        ...
        RegressionExample2.evaluate(network, dstest);
    }
}
